...
const earthData = [
    {
        ...
        text: `
            <ul class="list-disc">
                ...
                <li class="my-4">Understanding light's role is crucial for assessing the health of ocean ecosystems.</li>
            </ul>
        `
    },
    {
        ...
        text: `
            <ul class="list-disc">
                ...
                <li class="my-4">The depth of light penetration impacts the distribution of marine organisms.</li>
            </ul>
        `
    },
    {
        ...
        text: `
            <ul class="list-disc">
                ...
                <li class="my-4">Understanding these color changes helps in studying marine biodiversity.</li>
            </ul>
        `
    }
];
    ...
    return (
        <div class="relative h-screen bg-black text-white">
            ...
            <div class="relative flex flex-col items-center justify-center h-full text-center bg-black bg-opacity-80 p-6 rounded-lg">
                <h1 class="text-6xl font-extrabold mb-6 bg-gradient-to-r from-blue-400 to-green-400 text-transparent bg-clip-text">Explore the Role of Light in the Ocean</h1>
                <p class="text-xl mt-4 max-w-3xl leading-relaxed">
                    Discover how sunlight penetrates the ocean and supports marine ecosystems. Understand how different wavelengths of light influence ocean color and marine life.
                </p>
            ...
            <div class="container w-full text-center bg-gradient-to-br from-zinc-900 via-neutral-950 to-black p-8 rounded-lg shadow-lg shadow-green-700">
                ...
                <div class="flex flex-wrap justify-evenly my-4 p-4">
                    <Card
                        ...
                        points="Sunlight is crucial for photosynthesis in marine ecosystems. It penetrates the ocean surface, enabling phytoplankton to produce oxygen, forming the foundation of the marine food web."
                    />
                    <Card
                        image="/lessons/lessonContent/lesson3/3.2.jpg"
                        title="Wavelength Absorption"
                        points="Different wavelengths of light are absorbed at different depths in the ocean. Red light is absorbed quickly, while blue light penetrates deeper, influencing marine life behavior and the ocean's appearance."
                    />
                    <Card
                        image="/lessons/lessonContent/lesson3/3.3.jpg"
                        title="Impact on Marine Life"
                        points="Light availability influences the distribution and behavior of marine organisms. Many species rely on sunlight for navigation, reproduction, and finding food, making light a critical factor in marine biodiversity."
                    />
                    <Card
                        image="/lessons/lessonContent/lesson3/3.4.jpg"
                        title="Ocean Color Dynamics"
                        points="The varying absorption of light gives the ocean its distinctive colors. The ocean appears blue due to the deep penetration of blue light, while other colors like red are absorbed quickly, affecting our perception of water quality."
                    />
                </div>
            </div>
        </section>
    ...
    return (
        <div class="bg-black">
            <button
                ...
                class="mt-1 mb-8 bg-blue-700 text-white py-2 px-4 rounded-lg hover:bg-blue-700 transition-colors"
            >
                Back to Lessons
            </button>
            <HeroSection />
